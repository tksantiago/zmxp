...
new modetext[][] = { "Normal", "Proximidade", "Impacto", "Trip Laser", "Sensor de Movimento", "Explode quando aperta E", "Perseguir" }
...
public plugin_init()
{
	...
	register_plugin("[ZMXP] NadeModes", VERSION, "Nomexous & OT")
